...
LOCAL_CFLAGS:=		-DMKSHRC_PATH=\"/system/etc/mkshrc\" \
			...
			-DMKSH_DEFAULT_TMPDIR=\"/data/data\" \
			-fwrapv \
			-DMKSH_ASSUME_UTF8=0 -DMKSH_CONSERVATIVE_FDS \
			-DMKSH_DISABLE_DEPRECATED -DMKSH_DONT_EMIT_IDSTRING \
			...
			-DHAVE_PATHS_H=1 -DHAVE_STDINT_H=1 \
			...
			-DHAVE_FLOCK=1 -DHAVE_LOCK_FCNTL=1 \
			-DHAVE_GETRUSAGE=1 -DHAVE_KILLPG=1 -DHAVE_MKNOD=0 \
			-DHAVE_MMAP=1 -DHAVE_NICE=1 -DHAVE_REVOKE=0 \
...
# check categories: android convfds nodeprecated no-histfile
